...
export async function POST(request: NextRequest) {
  try {
    ...
    //      client_x509_cert_url — they are metadata in the downloaded
    //      JSON key file but NOT accepted by googleapis credentials.
    ...
    // ── Agreement clauses ─────────────────────────────────────────────
    const agreementBody = `AFFILIATE PARTNER AGREEMENT
Version 1.0 - January 2026

This Affiliate Partner Agreement ("Agreement") is entered into on this ${effectiveDateDisplay}, by and between:
...
AND
Affiliate Manager ("Partner" or "Manager"), having PAN No: ${panNumber} with registered/residential address at ${partnerAddress}
...
4.4 Sub-Manager Responsibilities: Sub-Managers shall: (a) Onboard and activate Candidates within their assigned Pin Code Territories; (b) Link Candidates to specific pin codes on the Platform; (c) Provide first-level support, training, and troubleshooting assistance; (d) Monitor assignment completion, quality, and Candidate performance; (e) Ensure compliance with Platform policies and quality standards.
4.5 Manager's Liability: The Manager remains responsible and liable for all Sub-Managers and Candidates in their Network, including: (a) Quality of work delivered by any Candidate in the Network; (b) Compliance with Platform policies, ethical standards, and applicable laws; (c) Any misconduct, fraud, or breach by Sub-Managers or Candidates.

5. CANDIDATE ONBOARDING & TERRITORY ALLOCATION
5.1 Onboarding Process: Managers/Sub-Managers shall onboard Candidates through the Platform by: (a) Collecting Candidate's Aadhaar; (b) Bank details or UPI; (c) Obtaining explicit written/digital consent from the Candidate on fee structure and engagement terms (as per Annexure A); (d) Location.
5.2 KYC Verification: (a) Collecting Candidate's Aadhaar; (b) Bank details or UPI.
...
7. AUDIT FEE DISTRIBUTION MODEL
7.1 Manager-Controlled Distribution: The Partner shall have complete control and authority over the distribution of audit fees among Candidates and any appointed Sub-Managers within their Network, subject to: (a) Explicit written consent from each Candidate as per Section 5.5; (b) Compliance with applicable minimum wage laws (if any); (c) Fair dealing and transparency in communicating fee structure to Candidates.
...
9.3 Client Feedback & Rating System: Clients may provide feedback and ratings (1-5 stars). Persistent low ratings (average below 3.0 stars over 5 assignments, or below 2.5 stars over 3 assignments) may result in: (a) Manager-led counseling and additional training; (b) Temporary suspension from new assignments; (c) Termination from the Platform (at Company's discretion after giving Manager opportunity to remediate).
9.4 Quality Review & Audit: The Company reserves the right to: (a) Conduct random quality audits of completed assignments; (b) Request revision if deliverables do not meet standards; (c) Withhold payment pending satisfactory completion of revisions; (d) Share quality audit findings with the Manager for corrective action.
9.5 Client Complaints & Remediation: If a client raises a complaint: (a) The Company shall notify the Manager and Candidate within 24 hours; (b) The Candidate must respond within 48 hours; (c) Revision must be completed within 3-5 business days; (d) If Candidate cannot rectify, Manager may assign another Candidate; (e) Additional rectification costs shall be borne by original Candidate/Manager unless reimbursed by the client; (f) Repeated complaints (3+ within 6 months) may lead to suspension or termination of the candidate.
...
11.2 Non-Circumvention by Company: The Company shall not: (a) Bypass the Partner to engage with the Partner's Candidates or Sub-Managers; (b) Reallocate Candidates to other Managers without consent; (c) Solicit Candidates to work outside the Platform; (d) Share Candidate contact information with third parties without consent.
11.3 Confidentiality Obligations: Both Parties agree to maintain strict confidentiality of: (a) Candidate data and performance metrics; (b) Commercial terms and revenue sharing mechanisms; (c) Client information and business strategies; (d) Proprietary Platform features and technological processes.
...
12.2 Personal Data Protection: All Parties shall comply with applicable data protection laws including IT Act, 2000, DPDP Act, 2023. Parties shall: (a) collect data only for legitimate purposes; (b) implement reasonable security measures; (c) not share data without consent; (d) report data breaches immediately.
...
15. LIABILITY, INDEMNIFICATION & INSURANCE
15.1 Company's Limitation of Liability: The Company's total liability shall be limited to aggregate amounts paid to Manager in preceding 12 months. Company is not liable for: (a) indirect, consequential, or punitive damages; (b) loss of business or reputation; (c) professional errors by Candidates/Managers; (d) client disputes or non-payment; (e) Platform downtime (except as per Section 6.3); (f) third-party claims from Candidate work.
15.2 Manager's Indemnification: Manager shall indemnify the Company against claims arising from: (a) work performed by Network Candidates; (b) breach of Agreement or laws; (c) professional negligence or errors; (d) IP infringement, fraud, or misrepresentation; (e) data breaches caused by Manager's actions; (f) violation of third-party rights.
15.3 Company's Indemnification: Company shall indemnify Manager against claims arising solely from: (a) Platform defects or security breaches caused by Company's negligence; (b) material misrepresentation of Platform capabilities by Company.
15.4 Insurance Recommendation: Company recommends (but does not mandate) that Managers maintain professional indemnity insurance. For assignments above INR 50,000, Candidates may be required to have insurance.
...
16.2 Acceptable Use Policy: Users shall not: (a) use Platform for unlawful purposes; (b) upload malicious software or breach security; (c) impersonate others or create fake profiles; (d) manipulate assignment allocation or billing; (e) solicit clients directly to bypass Platform; (f) defame or disparage Company, other Managers, or Candidates; (g) reverse engineer Platform.
16.3 Suspension & Termination Triggers: Company may suspend/terminate access if: (a) Manager commits fraud or ethical violations; (b) repeated client complaints indicate quality issues; (c) confidentiality or data protection breached; (d) legal action initiated against Manager; (e) Platform misuse detected.
16.4 Appeals Process: If suspended: (a) Manager notified with reasons; (b) May appeal within 7 days with evidence; (c) Company reviews within 15 business days; (d) Final decision with Company, subject to Section 18 dispute resolution.
...
17.4 Termination for Cause: Either Party may terminate immediately if: (a) other Party materially breaches and fails to cure within 15 days; (b) other Party becomes insolvent or bankrupt; (c) legal/regulatory action prohibits continuation; (d) fraud or gross negligence proven.
17.5 Effect of Termination: Upon termination: (a) Manager's Platform access revoked immediately; (b) Manager entitled to payments for completed assignments; (c) Ongoing assignments may be completed with mutual consent; (d) Confidentiality, non-disclosure, non-circumvention obligations survive indefinitely; (e) Non-solicitation (Section 13) remains in effect for 12 months.
17.6 Transition of Network: Upon termination: (a) Sub-Managers and Candidates notified; (b) Company may offer Sub-Managers option to become direct Managers; (c) Candidates may be reassigned to other Managers, subject to their consent; (d) Terminated Manager shall not contact or solicit former Network for 12 months.
...
18.3 Arbitration: If mediation fails or not completed within 30 days, arbitration shall apply: (a) Sole arbitrator appointed by mutual consent within 15 days, else by MCIA or Indian Council of Arbitration; (b) Seat: Mumbai or Thane, Maharashtra; (c) Language: English; (d) Per Arbitration and Conciliation Act, 1996; (e) Award final and binding; (f) Each Party bears own costs unless arbitrator directs otherwise.
18.4 Exceptions to Arbitration: Does not apply to: (a) interim/injunctive relief (seek from courts); (b) recovery of undisputed payments; (c) IP infringement claims.

19. GOVERNING LAW & JURISDICTION
This Agreement shall be governed by the laws of India. Subject to Section 18 dispute resolution, courts at ${jurisdiction} shall have exclusive jurisdiction.
...
3. Fee Consent: I agree to receive INR ________ per assignment / INR ________ per day as decided by my Manager/Sub-Manager
...
Manager's share: INR 200 per man day
All the payments will be made directly by the Company to Candidate, Sub-Manager, and Manager. Manager and Sub-Manager will raise monthly invoice for their portion of the professional fee.
To protect the margins of Manager, Candidates and Sub-Manager will not have access to amount being paid to Manager and Sub-Manager. Similarly, to protect the margin of Sub-Manager, the Manager will not have access to amount being paid to Candidates onboarded by Sub-Managers. Similarly, no Manager or Sub-Manager will have access to amount being paid to other Managers and Sub-Managers.
...
IN WITNESS WHEREOF, the Parties have executed this Agreement on the date first written above.`
    ...
    doc.text('(Yours Faithfully Advisors LLP / AuditVeda)', leftX, yPosition + 5)

    // ── Partner header ──────────────────────────────────────────────
    doc.text('FOR THE PARTNER', rightX, yPosition)
    doc.text('(Affiliate Manager)', rightX, yPosition + 5)
    yPosition += 14
    ...
    // Designation (company) | PAN (partner)
    doc.text('Designation: __________________',              leftX,  yPosition)
    doc.text(`PAN: ${panNumber || '______________________'}`, rightX, yPosition)
    yPosition += 6
    ...
    doc.text('Place: _______________________',               rightX, yPosition)
    ...
    if (hasOAuth) {
      ...
      // FIX: only the fields that JWTInput actually accepts.
      // auth_uri, token_uri, auth_provider_x509_cert_url and
      // client_x509_cert_url exist in the downloaded JSON key file but
      // are NOT part of the googleapis credential type — the library
      // already knows Google's token endpoint internally.
    ...
    // Only add driveId / supportsAllDrives when the env var exists.
